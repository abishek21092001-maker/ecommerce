...
public class ProductController {
	...
	@PutMapping("/{id}")
	public String updateproductbyid(@PathVariable Long id , @ModelAttribute ProductRequestDto productrequestdto, @RequestParam MultipartFile Image) throws IOException {
		

		return productserviceimp.updateproductbyid(id,productrequestdto,Image);
